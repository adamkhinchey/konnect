...
export class EventTimelineFunctionComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  timelineRenderSubject = new Subject<{ elem: HTMLElement, data: EventTimelineDataInterface | undefined }>();
  ...
  fetchServicesTimelineData(callback: (data: EventTimelineDataInterface | undefined) => void): void {
  ...
  fetchExhibitorsTimelineData(callback: (data: EventTimelineDataInterface | undefined) => void): void {
