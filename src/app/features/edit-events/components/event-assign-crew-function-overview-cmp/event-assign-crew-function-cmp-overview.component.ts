...
@Component({
  selector: 'app-event-assign-crew-function-cmp-overview',
  templateUrl: './event-assign-crew-function-cmp-overview.component.html',
  styleUrls: ['./event-assign-crew-function-cmp-overview.component.scss']
})
export class EventAssignCrewFunctionCmpOverviewComponent implements OnInit, OnChanges {
