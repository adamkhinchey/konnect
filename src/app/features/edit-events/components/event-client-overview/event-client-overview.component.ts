...
@Component({
  selector: 'app-event-client-overview',
  templateUrl: './event-client-overview.component.html',
  styleUrls: ['./event-client-overview.component.scss'],
})
export class EventClientoverviewComponent
