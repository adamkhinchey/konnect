...
@Component({
  selector: 'app-event-suppliers-overview',
  templateUrl: './event-suppliers-overview.component.html',
  styleUrls: ['./event-suppliers-overview.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default,
})
export class EventSuppliersOverviewComponent
