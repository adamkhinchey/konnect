...
@Component({
  selector: 'app-event-exhibitors-overview',
  templateUrl: './event-exhibitors-overview.component.html',
  styleUrls: ['./event-exhibitors-overview.component.scss'],
})
export class EventExhibitorsOverviewComponent
