...
@Component({
  selector: 'app-event-assign-function-cmp-overview',
  templateUrl: './event-assign-function-cmp-overview.component.html',
  styleUrls: ['./event-assign-function-cmp-overview.component.scss']
})
export class EventAssignFunctionCmpOverviewComponent implements OnInit, OnChanges {
