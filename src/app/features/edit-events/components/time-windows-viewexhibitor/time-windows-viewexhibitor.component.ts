...
@Component({
  selector: 'app-time-windows-viewexhibitor',
  templateUrl: './time-windows-viewexhibitor.component.html',
  styleUrls: ['./time-windows-viewexhibitor.component.scss']
})
export class TimeWindowsviewexhibitorComponent implements OnInit, OnDestroy {
